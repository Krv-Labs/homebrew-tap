class Topos < Formula
  ...
  url "https://github.com/Krv-Labs/topos/releases/download/v0.4.4/topos-macos-arm64"
  sha256 "82d041e4a35ce29d1929a0f80017fd5689535029665602c99ecf8c13d52ce6fe"
  ...
  on_linux do
    on_intel do
      url "https://github.com/Krv-Labs/topos/releases/download/v0.4.4/topos-linux-amd64"
      sha256 "ceb8341cb52c1a46f4bdad8dd241f174a13f8e302c748b17adc9170908b19f03"
    end
    on_arm do
      url "https://github.com/Krv-Labs/topos/releases/download/v0.4.4/topos-linux-arm64"
      sha256 "6cd9a37087b97fb8d4dc80b7cd221364e41f31f850c7b468c3f06e359325cbc6"
    end
  end
